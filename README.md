...
| `product-xa-u-2in1.jpg` | Ảnh sản phẩm "Xả & Ủ Tóc 2in1" (sắp ra mắt) – card ở `san-pham.html` | ⬜ Chưa có – khuyến nghị **1000 × 1000px**, có thể để trống tới khi sản phẩm ra mắt |
| `product-xit-duong-toc.jpg` | Ảnh sản phẩm "Xịt Dưỡng Tóc" (sắp ra mắt) – card ở `san-pham.html` | ⬜ Chưa có – khuyến nghị **1000 × 1000px**, có thể để trống tới khi sản phẩm ra mắt |
...
| `fonscare-ve-sinh-cert-1.jpg`, `fonscare-ve-sinh-cert-2.jpg` | Ảnh hồ sơ công bố / kết quả kiểm nghiệm Dung Dịch Vệ Sinh Fons Care – trang `minh-chung-chat-luong.html` (mục `#fonscare-ve-sinh`) | ⬜ Chưa có – khuyến nghị **1000 × 1400px**, chỉ thêm khi có hồ sơ thật |
| `fonscare-baby-cert-1.jpg`, `fonscare-baby-cert-2.jpg` | Ảnh hồ sơ công bố / kết quả kiểm nghiệm Sữa Tắm Gội Fons Care Baby – trang `minh-chung-chat-luong.html` (mục `#fonscare-baby`) | ⬜ Chưa có – khuyến nghị **1000 × 1400px**, chỉ thêm khi có hồ sơ thật |
| `fonscare-ve-sinh-gallery-1.jpg` → `-9.jpg` | **Gallery 9 ảnh** ở trang chi tiết Dung Dịch Vệ Sinh Fons Care `fonscare-dung-dich-ve-sinh.html` (ảnh chính + 9 thumbnail), cùng bố cục với gallery Dầu Gội Mộc Sa | ⬜ Chưa có – khuyến nghị **1000 × 1000px** mỗi ảnh |
| `fonscare-baby-gallery-1.jpg` → `-9.jpg` | **Gallery 9 ảnh** ở trang chi tiết Sữa Tắm Gội Fons Care Baby `fonscare-baby.html` (ảnh chính + 9 thumbnail) | ⬜ Chưa có – khuyến nghị **1000 × 1000px** mỗi ảnh |
| `avatar-trang-trang.jpg`, `avatar-minh-anh.jpg`, `avatar-thu-ha.jpg` | Ảnh đại diện khách hàng đánh giá — dùng ở cả trang chủ và `san-pham-chi-tiet.html` (2 nơi review Dầu Gội Mộc Sa) | ⬜ Chưa có – tự động hiện chữ cái viết tắt (TT/MA/TH) nếu chưa có ảnh, khuyến nghị ảnh vuông **300 × 300px** |
| `avatar-ngoc-han.jpg`, `avatar-phuong-linh.jpg`, `avatar-khanh-chi.jpg` | Ảnh đại diện khách hàng đánh giá ở `fonscare-dung-dich-ve-sinh.html` | ⬜ Chưa có – tương tự, **300 × 300px** |
| `avatar-thanh-van.jpg`, `avatar-hai-ngan.jpg`, `avatar-quynh-anh.jpg` | Ảnh đại diện khách hàng đánh giá ở `fonscare-baby.html` | ⬜ Chưa có – tương tự, **300 × 300px** |
| `ingredient-caffeine.jpg`, `ingredient-but-giam.jpg`, `ingredient-xuong-rong.jpg`, `ingredient-gung.jpg`, `ingredient-bo-ket.jpg`, `ingredient-tia-to-bo-ket.jpg`, `ingredient-nam-men.jpg` | Ảnh từng thành phần trong card thảo dược — trang chủ hiện 5 thẻ (Caffeine, Bụt Giấm, Xương Rồng, Gừng, Bồ Kết tách riêng), trang Về Mộc Sa hiện 6 thẻ (Gừng riêng, Tía Tô + Bồ Kết vẫn gộp 1 ảnh) | ✅ Đã có — ảnh tư liệu (Wikimedia Commons, giấy phép tự do sử dụng), đã resize tối đa 1200px + nén nhẹ. Nếu có ảnh chụp nguyên liệu thật của bạn, cứ ghi đè theo đúng tên file này để thay thế |
